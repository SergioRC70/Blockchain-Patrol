...
Para completar el análisis de los datos, se incluyen en la entrega gráficos generados en PowerBI y en Excel.

Para ello se realizó una exportación a Excel del dataset crypto_summary_by_currency (que se adjunta también) para representar los siguientes diagramas con PowerBI.
...
- Posibles valores inflados. NVT alto sobre MarketCap bajo bajo.
- Posibles valores burbuja. NVT alto sobre volumen de operaciones sobre el MarketCap bajo.
