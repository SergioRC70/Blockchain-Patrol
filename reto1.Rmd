...
info_cuantitativa_ts_bitcoin$Date <- as.Date(info_cuantitativa_ts_bitcoin$Date)

info_cuantitativa_ts_bitcoin <- info_cuantitativa_ts_bitcoin %>%
...
#round(SharpeRatio(info_cuantitativa_ts_bitcoin[, "Return_Pctg", drop = FALSE], Rf = .0003), 4)

summary(info_cuantitativa_ts_bitcoin[, "Return_Pctg", drop = FALSE])
