...
Para ver umbrales de comportamiento anómalo, podemos calcular los cuantiles para las métricas calculadas para la oferta (los bids)
...
Dibujamos los gráficos de cajas para tener una representación visual de los valores medios de precios y profundidad, para oferta (bids) y demanda (asks)
...
(se puede apreciar que hay un gap de varias horas sin datos)

Empezamos con la oferta (bids)
...
grafica_evolucion_media_asks(datos_ADA_USDT, "10 sec", "Evolución del precio medio de asks ADA/USDT", "USDT")
grafica_evolucion_media_asks(datos_AVAX_USDT, "10 sec", "Evolución del precio medio de asks AVAX/USDT", "USDT")
grafica_evolucion_media_asks(datos_DOGE_USDT, "10 sec", "Evolución del precio medio de asks DOGE/USDT", "USDT")
grafica_evolucion_media_asks(datos_DOT_USDT, "10 sec", "Evolución del precio medio de asks DOT/USDT", "USDT")
grafica_evolucion_media_asks(datos_ETH_BTC, "10 sec", "Evolución del precio medio de asks ETH/BTC", "BTC")
grafica_evolucion_media_asks(datos_LTC_USDT, "10 sec", "Evolución del precio medio de asks LTC/USDT", "USDT")
grafica_evolucion_media_asks(datos_MATIC_USDT, "10 sec", "Evolución del precio medio de asks MATIC/USDT", "USDT")
grafica_evolucion_media_asks(datos_SHIB_USDT, "10 sec", "Evolución del precio medio de asks SHIB/USDT", "USDT")
grafica_evolucion_media_asks(datos_SOL_USDT, "10 sec", "Evolución del precio medio de asks SOL/USDT", "USDT")
grafica_evolucion_media_asks(datos_UNI_USDT, "10 sec", "Evolución del precio medio de asks UNI/USDT", "USDT")
grafica_evolucion_media_asks(datos_XRP_USDT, "10 sec", "Evolución del precio medio de asks XRP/USDT", "USDT")
grafica_evolucion_media_asks(datos_BTC_USDT, "10 sec", "Evolución del precio medio de asks BTC/USDT", "USDT")

```
Y ahora por cada cryptomoneda frente a USDT y ETH/USDT , una comparativa entre los movimientos de oferta y demanda en los que se aprecia cómo se correlacionan la una con otra.
```{r message= FALSE, warning=FALSE}
...
Carga de la información cuantitativa de las monedas en un único dataset:
```{r message= FALSE, warning=FALSE}
