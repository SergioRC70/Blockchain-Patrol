...
datos_ASA_USDT<-load(file="crypto_orderbooks_agregados_ADA_USDT.Rda")
datos_AVAX_USDT<-load(file="crypto_orderbooks_agregados_AVAX_USDT.Rda")
datos_DOT_USDT<-load(file="crypto_orderbooks_agregados_DOT_USDT.Rda")
datos_LTC_USDT<-load(file="crypto_orderbooks_agregados_LTC_USDT.Rda")
datos_MATIC_USDT<-load(file="crypto_orderbooks_agregados_MATIC_USDT.Rda")
datos_SHIB_USDT<-load(file="crypto_orderbooks_agregados_SHIB_USDT.Rda")
datos_SOL_USDT<-load(file="crypto_orderbooks_agregados_SOL_USDT.Rda")
datos_UNI_USDT<-load(file="crypto_orderbooks_agregados_UNI_USDT.Rda")
datos_XRP_USDT<-load(file="crypto_orderbooks_agregados_XRP_USDT.Rda")
